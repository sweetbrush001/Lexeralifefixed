    ...
    <ImageBackground source={require("../assets/images/jungle-background.jpg")} style={styles.container}>
      <View style={styles.overlay}>
        <LottieView
          source={
            percentage >= 80
              ? require("../assets/animations/great-score.json")
              : percentage >= 50
                ? require("../assets/animations/good-score.json")
                : require("../assets/animations/try-again.json")
          }
          autoPlay
          loop
        ...
        <ImageBackground
          source={require("../assets/images/wooden-panel.png")}
