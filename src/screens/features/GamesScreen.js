...
// If the assets folder is at the project root:
...
const GamesScreen = () => {
  ...
  const fontStyle = {
    fontFamily: settings.isDyslexicFriendly
    ...
    <TextReaderRoot>
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <ReadableText
            style={[styles.headerTitle, fontStyle]}
            readable={true}
            priority={1}
          >
        ...
        >
          <ReadableText
            style={[styles.introText, fontStyle]}
            readable={true}
            priority={2}
          >
            Train your brain with fun games designed to improve cognitive skills
            and help with dyslexia.
          </ReadableText>
        </LinearGradient>

        <ReadableText
          style={[styles.sectionTitle, fontStyle]}
          readable={true}
          priority={3}
        >
          Available Games
            ...
            <BlurView intensity={10} style={styles.cardBlur}>
              <View style={styles.gameCardContent}>
                ...
                <View style={styles.gameInfo}>
                  <ReadableText
                    style={[styles.gameTitle, fontStyle]}
                    readable={true}
                    priority={4}
                  >
                    Word Builder
                  ...
                  <ReadableText
                    style={[styles.gameDescription, fontStyle]}
                    readable={true}
                    priority={5}
                  >
              ...
              <View style={styles.gameCardContent}>
                ...
                <View style={styles.gameInfo}>
                  ...
                  <ReadableText
                    ...
                    priority={13}
                  >
                    Improve cognitive skills by identifying patterns and
                    sequences.
                  </ReadableText>
                </View>
              </View>
              ...
              <View style={styles.gameCardContent}>
                ...
                <View style={styles.gameInfo}>
                  ...
                  <ReadableText
                    ...
                    priority={15}
                  >
                    Advanced brain training with word associations and cognitive
                    challenges.
                  </ReadableText>
                </View>
              </View>
